...
export default function CourseCard({ course, onClick, onPurchaseClick }: CourseCardProps): React.ReactElement {
  const { address } = useAccount();
  const isMyCourse: boolean = !!address && course.author.toLowerCase() === address.toLowerCase();

...
import { CURRENT_CHAIN_ID, injectedConnector } from '@zuojipeng/my-libs/wagmi';
...
const AAVE_POOL_ADDRESS: Address = '0x6Ae43d3271ff6888e7Fc43Fd7321a503ff738951'; // Aave V3 Pool on Sepolia
const USDT_ADDRESS: Address = '0xaA8E23Fb1079EA71e0a56F48a2aA51851D8433D0'; // USDT on Sepolia

// Uniswap V3 Router 地址（Sepolia）
const UNISWAP_ROUTER: Address = '0x3bFA4769FB09eefC5a80d6E87c3B9C650f7Ae48E'; // Uniswap SwapRouter on Sepolia
...
type SwapStep = 'idle' | 'approving' | 'swapping' | 'success' | 'error';
type AaveStep = 'idle' | 'approving' | 'supplying' | 'success' | 'error';
...
function TreasuryPage() {
  ...
  const { data: instructorYield } = useReadContract({
    address: INSTRUCTOR_YIELD_ADDRESS as Address,
  ...
  // YD → ETH 兑换（第一步）
  const handleSwapYDToETH = async (): Promise<void> => {
    ...
    try {
      ...
      await writeSwap({
        ...
        args: [{
          tokenIn: YD_TOKEN_ADDRESS as Address,
          tokenOut: '0x0000000000000000000000000000000000000000' as Address, // WETH address (replace with actual)
          fee: 3000, // 0.3% fee tier
          recipient: address,
          amountIn: amountIn,
          amountOutMinimum: 0n, // 生产环境需要设置合理的滑点
  ...
  // USDT → Aave 存款
  const handleSupplyToAave = async (): Promise<void> => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                ...
                <p className="text-3xl font-bold text-yellow-400">
                  {ydBalance ? formatUnits(ydBalance as bigint, 18) : '0'} YD
                </p>
              </div>
              ...
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                ...
                <p className="text-3xl font-bold text-green-400">
                  {usdtBalance ? formatUnits(usdtBalance as bigint, 6) : '0'} USDT
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-gray-800 rounded-lg p-6 border-2 border-green-500">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    可用: {ydBalance ? formatUnits(ydBalance as bigint, 18) : '0'} YD
                  </p>
                </div>
              ...
              <div className="bg-gray-800 rounded-lg p-6 border-2 border-blue-500">
                ...
                <div className="mb-4">
                  ...
                  />
                  <p className="text-gray-500 text-xs mt-1">
                    可用: {usdtBalance ? formatUnits(usdtBalance as bigint, 6) : '0'} USDT
                  </p>
                </div>
